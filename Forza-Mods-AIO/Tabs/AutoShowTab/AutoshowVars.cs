    ...
    internal class AutoshowVars
    {
        ...
        public async Task Scan()
        {
            ...
            if (MainWindow.mw.gvp.Name == "Forza Horizon 4")
            {
                ...
                UpdateUi.AddProgress(ScanAmount, 1, AutoShow.AS.AOBProgressBar);
                ...
                UpdateUi.AddProgress(ScanAmount, 2, AutoShow.AS.AOBProgressBar);
                ...
                UpdateUi.AddProgress(ScanAmount, 3, AutoShow.AS.AOBProgressBar);
                ...
                UpdateUi.AddProgress(ScanAmount, 4, AutoShow.AS.AOBProgressBar);
                ...
                UpdateUi.AddProgress(ScanAmount, 5, AutoShow.AS.AOBProgressBar);
                ...
                UpdateUi.AddProgress(ScanAmount, 6, AutoShow.AS.AOBProgressBar);
                ...
                UpdateUi.AddProgress(ScanAmount, 7, AutoShow.AS.AOBProgressBar);
                ...
                UpdateUi.AddProgress(ScanAmount, 8, AutoShow.AS.AOBProgressBar);
                ...
                UpdateUi.AddProgress(ScanAmount, 9, AutoShow.AS.AOBProgressBar);
                ...
                UpdateUi.AddProgress(ScanAmount, 10, AutoShow.AS.AOBProgressBar);
                ...
                UpdateUi.AddProgress(ScanAmount, 11, AutoShow.AS.AOBProgressBar);
                ...
                UpdateUi.AddProgress(ScanAmount, 12, AutoShow.AS.AOBProgressBar);
                ...
                UpdateUi.AddProgress(ScanAmount, 13, AutoShow.AS.AOBProgressBar);
                ...
                UpdateUi.AddProgress(ScanAmount, 14, AutoShow.AS.AOBProgressBar);
                ...
                UpdateUi.AddProgress(ScanAmount, 15, AutoShow.AS.AOBProgressBar);
                ...
                UpdateUi.AddProgress(ScanAmount, 16, AutoShow.AS.AOBProgressBar);
                ...
                UpdateUi.AddProgress(ScanAmount, 17, AutoShow.AS.AOBProgressBar);
            }
            else
            {
