...
namespace Forza_Mods_AIO.Tabs.AutoShowTab
{
    internal class AutoshowVars
    {
        ...
        private static bool FinishedScan;
        #endregion
        ...
        public static void Scan()
        {
            ...
            if (MainWindow.mw.gvp.Name == "Forza Horizon 4")
            {
                ...
                while (sql2 == "0" && sql3 == "0" && sql4 == "0" && sql7 == "0" && sql8 == "0" && sql9 == "0" && sql11 == "0" && sql12 == "0" && sql13 == "0" &&
                       sql14 is "0" or "7FF" && sql1 == "0" && sql5 == "0" && sql6 == "0" && sql15 == "0" && sql16 == "1A" && sql17 == "0")
                {
                }
            ...
            while (Value < 100)
            {
                AutoShow.AS.Dispatcher.Invoke(() => Value = AutoShow.AS.AOBProgressBar.Value);
                Thread.Sleep(250);
            }
        ...
        {
            if (!MainWindow.mw.WasMapped || !FinishedScan)
                return;
