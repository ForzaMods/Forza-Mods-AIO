...
{
    private static readonly MenuOption UnlimitedBuildBudgetToggle = new("Unlimited Build Budget", false);
    private static readonly MenuOption UnbreakableSkillScoreToggle = new("Unbreakable Skill Score", false);
