...
{
    private static readonly Overlay.MenuOption FovLockValue = new("Value", "Float", 0f);
    private static readonly Overlay.MenuOption FovLockToggle = new("Enable", "Bool", false);
